...
(defbuild-script
  `(;; Macros (must be compiled first - no dependencies)
    ...
    "modeline"
    "echo"
    ;; Helm framework (depends on core, persist, echo)
    "helm"
    "helm-sources"
    "helm-tui"
    "helm-commands"
    ...
    ,@(if build-tui-only? '()
        `((gxc: "qt/keymap"   "-cc-options" ,qt-cc-opts "-ld-options" ,qt-ld-opts)
          ...
          (gxc: "qt/helm-qt"  "-cc-options" ,qt-cc-opts "-ld-options" ,qt-ld-opts)
          ...
          (gxc: "qt/commands-core2"  "-cc-options" ,qt-cc-opts "-ld-options" ,qt-ld-opts)
          (gxc: "qt/commands-edit"   "-cc-options" ,qt-cc-opts "-ld-options" ,qt-ld-opts)
          (gxc: "qt/commands-edit2"  "-cc-options" ,qt-cc-opts "-ld-options" ,qt-ld-opts)
          (gxc: "qt/commands-search" "-cc-options" ,qt-cc-opts "-ld-options" ,qt-ld-opts)
          (gxc: "qt/commands-search2" "-cc-options" ,qt-cc-opts "-ld-options" ,qt-ld-opts)
          (gxc: "qt/commands-file"   "-cc-options" ,qt-cc-opts "-ld-options" ,qt-ld-opts)
          (gxc: "qt/commands-file2"  "-cc-options" ,qt-cc-opts "-ld-options" ,qt-ld-opts)
          (gxc: "qt/commands-sexp"   "-cc-options" ,qt-cc-opts "-ld-options" ,qt-ld-opts)
          (gxc: "qt/commands-sexp2"  "-cc-options" ,qt-cc-opts "-ld-options" ,qt-ld-opts)
          (gxc: "qt/magit"           "-cc-options" ,qt-cc-opts "-ld-options" ,qt-ld-opts)
          (gxc: "qt/commands-ide"    "-cc-options" ,qt-cc-opts "-ld-options" ,qt-ld-opts)
          (gxc: "qt/commands-ide2"   "-cc-options" ,qt-cc-opts "-ld-options" ,qt-ld-opts)
          (gxc: "qt/commands-vcs"    "-cc-options" ,qt-cc-opts "-ld-options" ,qt-ld-opts)
          (gxc: "qt/commands-vcs2"   "-cc-options" ,qt-cc-opts "-ld-options" ,qt-ld-opts)
          ...
          (gxc: "qt/commands-shell2" "-cc-options" ,qt-cc-opts "-ld-options" ,qt-ld-opts)
          (gxc: "qt/commands-modes"  "-cc-options" ,qt-cc-opts "-ld-options" ,qt-ld-opts)
          (gxc: "qt/commands-modes2" "-cc-options" ,qt-cc-opts "-ld-options" ,qt-ld-opts)
          (gxc: "qt/snippets"       "-cc-options" ,qt-cc-opts "-ld-options" ,qt-ld-opts)
          ...
          (gxc: "qt/commands-parity10" "-cc-options" ,qt-cc-opts "-ld-options" ,qt-ld-opts)
