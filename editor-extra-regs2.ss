...
(def (register-extra-commands-2!)
  ...
  ;; Batch 13: Games & apps from editor-extra-notes5 (replaces stubs with real implementations)
  (register-command! 'tetris cmd-tetris-real)
  (register-command! 'tetris-left cmd-tetris-left)
  (register-command! 'tetris-right cmd-tetris-right)
  (register-command! 'tetris-rotate cmd-tetris-rotate)
  (register-command! 'tetris-down cmd-tetris-down)
  (register-command! 'tetris-drop cmd-tetris-drop)
  (register-command! 'snake cmd-snake-real)
  (register-command! 'snake-up cmd-snake-up)
  (register-command! 'snake-down cmd-snake-down)
  (register-command! 'snake-left cmd-snake-left)
  (register-command! 'snake-right cmd-snake-right)
  (register-command! 'snake-step cmd-snake-step)
  (register-command! 'dunnet cmd-dunnet-real)
  (register-command! 'dunnet-command cmd-dunnet-command)
  (register-command! '2048-game cmd-2048)
  (register-command! '2048-up cmd-2048-up)
  (register-command! '2048-down cmd-2048-down)
  (register-command! '2048-left cmd-2048-left)
  (register-command! '2048-right cmd-2048-right)
  (register-command! 'animate-birthday cmd-animate-birthday)
  (register-command! 'animate-string cmd-animate-string)
  (register-command! 'type-break-mode cmd-type-break-mode-real)
  (register-command! 'type-break-status cmd-type-break-status)
  (register-command! 'type-break-reset cmd-type-break-reset)
  (register-command! 'highlight-changes-mode cmd-highlight-changes-real)
  (register-command! 'highlight-changes-mark-region cmd-highlight-changes-mark-region)
  (register-command! 'glasses-mode cmd-glasses-mode-real)
  (register-command! 'solitaire cmd-solitaire)
  (register-command! 'solitaire-up cmd-solitaire-up)
  (register-command! 'solitaire-down cmd-solitaire-down)
  (register-command! 'solitaire-left cmd-solitaire-left)
  (register-command! 'solitaire-right cmd-solitaire-right)
  (register-command! 'solitaire-jump-up cmd-solitaire-jump-up)
  (register-command! 'solitaire-jump-down cmd-solitaire-jump-down)
  (register-command! 'solitaire-jump-left cmd-solitaire-jump-left)
  (register-command! 'solitaire-jump-right cmd-solitaire-jump-right)
  (register-command! 'blackbox cmd-blackbox)
  (register-command! 'blackbox-shoot cmd-blackbox-shoot)
