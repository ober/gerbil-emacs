...
(def (qt-register-extended-commands!)
  ...
  ;; eww-add-bookmark, eww-list-bookmarks, forge-* moved to commands-aliases2.ss
  ;; Remote file editing
  ...
  (register-command! 'ibuffer-mark-delete cmd-ibuffer-mark-delete)
  ...
  (register-command! 'ibuffer-goto-buffer cmd-ibuffer-goto-buffer)
  (register-command! 'ibuffer-filter-name cmd-ibuffer-filter-name)
  (register-command! 'ibuffer-sort-name cmd-ibuffer-sort-name)
  (register-command! 'ibuffer-sort-size cmd-ibuffer-sort-size)
  (register-command! 'ibuffer-toggle-marks cmd-ibuffer-toggle-marks)
  (register-command! 'ibuffer-refresh (lambda (app) (ibuffer-refresh! app)))
  ;; WDired
...
(def (qt-register-alias-commands!)
  ...
  (register-command! 'ibuffer-mark-modified-buffers cmd-ibuffer-mark-save)
  (register-command! 'ibuffer-mark-unsaved-buffers cmd-ibuffer-mark-save)
