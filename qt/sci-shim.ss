...
(export
  ;; Re-export :gerbil-qt/qt minus the functions we replace
  (import: (except-in :gerbil-qt/qt
    ;; Editor widget functions — replaced by QScintilla equivalents
    ...
    ;; Document management — replaced by Scintilla document model
    ...
    ;; Line number area — built into QScintilla margins
    ...
    ;; Syntax highlighter — replaced by Scintilla lexers
  ...
  *doc-editor-map* *doc-buffer-map*
  ...
  ;; Replacement document functions
  qt-plain-text-document-create
  qt-text-document-create
  qt-text-document-destroy!
  qt-text-document-modified?
  ...
  ;; No-op line number area functions (built into QScintilla)
  qt-line-number-area-create
  qt-line-number-area-destroy!
  qt-line-number-area-set-visible!
  qt-line-number-area-set-bg-color!
  ...
  ;; No-op syntax highlighter functions (replaced by Scintilla lexers)
  qt-syntax-highlighter-create
  qt-syntax-highlighter-destroy!
  qt-syntax-highlighter-add-rule!
  qt-syntax-highlighter-add-keywords!
  ...
  ;; Scintilla indicator-based extra selections
  qt-extra-selections-clear!
  qt-extra-selection-add-line!
  qt-extra-selection-add-range!
  qt-extra-selections-apply!)
